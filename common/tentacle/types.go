...
type Factory[T Cloner[T]] func() (Worker[T], error)

// Worker 用于处理具体业务对接口方法
type Worker[T Cloner[T]] func(inputs chan int64, outputs chan *box[T])
